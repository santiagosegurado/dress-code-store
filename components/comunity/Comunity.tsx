...
const Comunity = () => {
  return (
    <div className="text-white flex flex-col items-center relative gap-10 justify-center">
      <div className="h-[100%] w-full blur-3xl bg-[rgba(44,24,51,0.6)] absolute top-0 right-0 "></div>

      <header className="flex flex-col items-center gap-2 z-30">
      ...
      <section className="z-30 flex flex-col md:flex-row gap-9">
        <article className="w-[350px] h-[300px] flex flex-col items-center bg-[#3737374d] justify-center p-16 gap-4 rounded-lg hover:drop-shadow-[0_0px_45px_rgba(255,255,255,0.3)] transition-all duration-300 cursor-pointer">
      ...
      <div className="z-30 flex flex-row items-center gap-5">
        <Link href={"#"}>
          <motion.span
            animate={{
        ...
        <Link href={"https://smartmockups.com/es/mockup/e7Cvg5E%24nr2"}>
          <motion.span
            animate={{
              background: "linear-gradient(to left, #43ff6400,  #43ff6400)",
            }}
            whileHover={{
              background: "linear-gradient(to left, #FFAC30, #FD76CB)",
              color: "#FFFFFF",
            ...
            className="text-gray-300 font-semibold text-[14px] md:text-[16px] rounded-md px-3 py-2 cursor-pointer"
          >
            Ver mockups
          </motion.span>
        </Link>
